...
/**
 * Visibility Gate for Bicep Curl per VISIBILITY_POLICY.md and EXERCISE_SPEC.md.
 *
 * Required landmarks:
 * - Shoulders (11, 12)
 * - Elbows (13, 14)
 ...
 */
internal class BicepCurlVisibilityGate(
    ...
    val minRequiredLandmarksPresent: Float = 0.50f,
    val boundaryMargin: Float = 0.02f
) {
    companion object {
        val BICEP_CURL_REQUIRED_LANDMARKS = listOf(
    ...
    fun getRequiredLandmarks(): List<Int> = BICEP_CURL_REQUIRED_LANDMARKS
    ...
    fun checkFrame(poseResult: PoseEstimationResult): FrameVisibilityResult {
        ...
        // 2. Out-of-frame boundary detection & presence count
        var presentCount = 0
