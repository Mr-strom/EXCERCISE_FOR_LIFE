...
/**
 * Visibility Gate for Plank per VISIBILITY_POLICY.md and EXERCISE_SPEC.md #7.
 *
 * Primary Landmarks:
 * - Shoulders (11, 12)
 * - Elbows (13, 14)
 ...
 *
 * Requirements:
 * - In profile/side view, requires at least one complete side (shoulder, elbow, hip, ankle)
 *   to be visible above the visibility threshold.
 ...
 */
internal class PlankVisibilityGate(
    val exerciseId: String = "plank",
    ...
    companion object {
        val PLANK_REQUIRED_LANDMARKS = listOf(
    ...
    fun getRequiredLandmarks(): List<Int> = PLANK_REQUIRED_LANDMARKS
    ...
    fun checkFrame(poseResult: PoseEstimationResult): FrameVisibilityResult {
        ...
        for (reqIdx in PLANK_REQUIRED_LANDMARKS) {
        ...
        // 3. Side-view landmark check: at least one complete side must be visible
        ...
        if (!leftVisible && !rightVisible) {
            ...
            missingIndices.addAll(PLANK_REQUIRED_LANDMARKS)
        }
